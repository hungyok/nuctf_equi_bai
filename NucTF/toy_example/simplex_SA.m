...
if contd>0
   ...
   fnx1 = fullfile(strcat(path1,foldername1),foldername3,'top1_xhIIa.mat');
   load(fnx1);
...
xi=x;
for i=1:(n+1) 
    Fsig(i,1)=optimbfunc_ver3a(xi(:,i),E,Em,Etfmul,Emtf); fprintf('print i....%d \n',i); 
end
