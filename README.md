...
## Output data
The main outputs from this exercise are the occupancy profiles of nucleosome and TF:

	1. The output files "O.mat" without remodeling effect (NucTF) can be found in the folders [example1](https://github.com/hungyok/nuctf_equi_bai/tree/main/NucTF/occup_profile/example1) and [example2](https://github.com/hungyok/nuctf_equi_bai/tree/main/NucTF/occup_profile/example2).
	2. The output file "O.mat" with remodeling effect (NucRemod) can be found in [occup_profile](https://github.com/hungyok/nuctf_equi_bai/tree/main/NucRemod/occup_profile).
